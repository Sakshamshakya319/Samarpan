        ...
        {transportationDetails.status === "assigned" && transportationDetails.driverNumber ? (
          <div className="space-y-3 p-4 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-heading font-semibold text-green-900">Driver Assigned</h3>
            </div>
          ...
          <div className="space-y-2 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-heading font-semibold text-yellow-900">Driver Assignment Pending</h3>
            </div>
