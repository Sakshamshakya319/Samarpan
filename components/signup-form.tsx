...
export function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // If signup was successful, also set user state
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        <CardTitle className="text-2xl">Join Samarpan</CardTitle>
      ...
      <CardContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {validationError && (
            <div className="p-3 bg-destructive/10 text-destructive rounded-md text-sm">{validationError}</div>
          )}
