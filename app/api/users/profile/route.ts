  ...
  try {
    ...
    return NextResponse.json({
      user: {
        ...
        bloodGroupVerified: user.bloodGroupVerified || false,
        bloodGroupVerifiedAt: user.bloodGroupVerifiedAt,
  ...
  try {
    ...
    return NextResponse.json({
      ...
      user: {
        ...
        bloodGroupVerified: updatedUser.bloodGroupVerified || false,
        bloodGroupVerifiedAt: updatedUser.bloodGroupVerifiedAt,
