    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-background via-secondary/20 to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-heading text-5xl md:text-6xl font-bold mb-6">Terms of Service</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">1. Acceptance of Terms</h2>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">2. Eligibility</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">3. User Accounts</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">4. Donations and Requests</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">5. Prohibited Conduct</h2>
              <div className="space-y-4 text-muted-foreground">
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">6. Content Ownership</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">7. Privacy</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">8. Cookies</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">9. Limitation of Liability</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">10. Indemnification</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">11. Termination</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">12. Governing Law</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8 mb-8">
              <h2 className="font-heading text-3xl font-bold mb-6">13. Changes to Terms</h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
            ...
            <Card className="p-8">
              <h2 className="font-heading text-3xl font-bold mb-6">14. Contact Us</h2>
              <div className="space-y-4 text-muted-foreground">
